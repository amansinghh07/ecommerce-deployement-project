package com.aman.ecommerce.order_service.service;
...
import com.aman.ecommerce.order_service.dto.OrderRequestItemDto;
import com.aman.ecommerce.order_service.entity.OrderItem;
import com.aman.ecommerce.order_service.entity.OrderStatus;
import com.aman.ecommerce.order_service.entity.Orders;
...
public class OrderService  {
    ...
    public OrderRequestDto getOrderById(Long id) {
        ...
        Orders order = orderRepository.findById(id).orElseThrow(()->
                new RuntimeException("Order not found for id "+id));
